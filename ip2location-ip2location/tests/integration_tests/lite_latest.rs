...
#[tokio::test]
async fn test_db11() -> Result<(), Box<dyn std::error::Error>> {
    let path_csv_v4 = "data/ip2location-lite/latest/IP2LOCATION-LITE-DB11.CSV";
    let path_csv_v6 = "data/ip2location-lite/latest/IP2LOCATION-LITE-DB11.IPV6.CSV";
